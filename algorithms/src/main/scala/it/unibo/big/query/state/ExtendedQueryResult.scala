...
import it.unibo.big.input.DataDefinition.{Data, NullData, NumericData}
import it.unibo.big.input.GPSJConcepts.Operators._
import it.unibo.big.input.GPSJConcepts.{Aggregation, GPQuery}
import it.unibo.big.input.RecordModeling.Record
import it.unibo.big.query.state.StateDefinitionUtils.getStartingMeasuresValues
