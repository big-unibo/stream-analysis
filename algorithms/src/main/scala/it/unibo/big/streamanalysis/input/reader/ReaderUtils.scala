package it.unibo.big.streamanalysis.input.reader

import it.unibo.big.streamanalysis.input.DataDefinition._
import it.unibo.big.streamanalysis.input.RecordModeling.Record
import it.unibo.big.streamanalysis.input.DataDefinition
import it.unibo.big.streamanalysis.utils.FileReader
import FileReader.MyConverter
