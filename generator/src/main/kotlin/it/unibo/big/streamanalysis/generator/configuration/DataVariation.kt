...
data class DataVariation(val delay: Long, val frequency: Long, val extension: Double, val impact: Double) {
    ...
    private fun getRandomBehavior(dimensionConfig: DimensionConfig, elapsedTime: Long): DimensionConfig {
        ...
        val decreaseProbabilityBehaviors = listOf(
            BehaviorInfo(DecreaseProbability::class), BehaviorInfo(Disappear::class), BehaviorInfo(
                Fixed::class, changeValues = false, increase = false)
        )
        val increaseProbabilityBehaviors = listOf(
            BehaviorInfo(IncreaseProbability::class), BehaviorInfo(Appear::class), BehaviorInfo(
                Fixed::class, changeValues = false, increase = true)
        )
