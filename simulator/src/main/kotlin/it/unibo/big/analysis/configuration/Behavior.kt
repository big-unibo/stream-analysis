...
import it.unibo.big.analysis.configuration.Behavior.Companion.calculateValue
...
@Serializable
@SerialName("Appear")
data class Appear(val probability: Double, override val behaviorDelay: Long, override val settlingDelay: Long, val values: Int) : IncreaseBehavior {
    init {
...
data class IncreaseProbability(override val startingProbability: Double, override val wantedProbability: Double, override val behaviorDelay: Long, override val settlingDelay: Long, val values: Int) : IncreaseBehavior {
    init {
...
data class IncreaseValues(val probability: Double, override val behaviorDelay: Long, override val settlingDelay: Long, override val startingValues: Int, override val wantedValues: Int) : IncreaseBehavior {
    init {
...
data class Disappear(val probability: Double, override val behaviorDelay: Long, override val settlingDelay: Long, val values: Int) : DecreaseBehavior {
    init {
...
data class DecreaseProbability(override val startingProbability: Double, override val wantedProbability: Double, override val behaviorDelay: Long, override val settlingDelay: Long, val values: Int) : DecreaseBehavior {
    init {
...
data class DecreaseValues(val probability: Double, override val behaviorDelay: Long, override val settlingDelay: Long, override val startingValues: Int, override val wantedValues: Int) : DecreaseBehavior {
    init {
