...
object DatasetsUtils {
  ...
  sealed trait Technogym extends RealDataset {
    override val datasetType: String = "bbm-mdm-mma"
    override val timeKey: String = ""
  }

  case object ManualActivities extends Technogym {
    override val datasetName: String = "ManualActivities"
  }

  case object DailyMovments extends Technogym {
    override val datasetName: String = "DailyMovements"
  }
